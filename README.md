...
A virtual ecommerce website using Node js, Express js, and Mongoose for XenonStack Task submission.
...
The application is deployed to Google Cloud Platform and can be accessed through the following link:

[BestBags on Google Cloud Platform](http://34.93.7.197/)
